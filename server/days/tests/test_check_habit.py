...
class CheckHabitTest(APITestCase):
    def test_check_habit_does_not_exist(self):
        client = APIClient()
    ...
    def test_check_habit_date_format_is_invalid(self):
    ...
    def test_check_habit_did_not_started_yet(self):
    ...
    def test_check_habit_day_obj_does_not_exist(self):
        today = datetime.today().date()
        habit = Habit.objects.create(name="habit1", start_at=today)
    ...
    def test_check_habit_never_checked_before(self):
        today = datetime.today().date()
        habit = Habit.objects.create(name="habit1", start_at=today)
